<div class="d-dural-flex-child2 p-3" >
    <p class="text-center" style="font-weight: bolder; color:gray;">our_service Banner</p>
       <form action="our_service_get.php" id="list" method="post">
...
<small style="position:absolute; top:-10px;right: -10px;" class="p-3 bg-twist rounded fw-bold text-white">our_service image</small>

        <div class="p-3 align-items-center" style="width: 100%;">
<strong for="content" class="p-3">Services description</strong>
<br>    
        <textarea type="text" required name="topic" class="fw-bold p-1 content" >Services topic </textarea>
        
        </div>
<div class="p-3 align-items-center" style="width: 100%;">
<strong for="content" class="p-3">Services description</strong>
<br>    
        <textarea type="text" required name="textbox" class="fw-bold p-1 content" >services description</textarea>
...
border-top-left-radius: 0;" id="pub">Add services</button>
