...
$get = $_GET['topic'];
$Sci_con=$conn->prepare("SELECT * FROM banner WHERE id=? order by id DESC LIMIT 1");
...
<div class="d-dural-flex-child2 p-3" >
    <p class="text-center" style="font-weight: bolder; color:gray;">Header Banner</p>
       ...
       <form action="banner-update.php" id="list" method="post">
...
<small style="position:absolute; top:-10px;right: -10px;" class="p-3 bg-twist rounded fw-bold text-white">Edit Banner</small>
...
<br>    
        <textarea type="text" required name="textbox" class="fw-bold p-1 content" value="<?php  echo $Sci_content; ?>" > <?php  echo $Sci_content; ?></textarea>
...
setTimeout(function () {
// body...
$space_load('banner-edit.php?topic=<?php echo $Sci_id; ?>','sign')
