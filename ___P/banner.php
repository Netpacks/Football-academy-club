<div class="d-dural-flex-child2 p-3" >
    <p class="text-center" style="font-weight: bolder; color:gray;">Header Banner</p>
       <form action="banner_get.php" id="list" method="post">
...
<small style="position:absolute; top:-10px;right: -10px;" class="p-3 bg-twist rounded fw-bold text-white">Banner image</small>


<div class="p-3 align-items-center" style="width: 100%;">
<strong for="content" class="p-3">Services Topic</strong>
<br>    
        <textarea type="text" required name="topic" class="fw-bold p-1 content"  > Service Topic</textarea>
        
        </div>

<div class="p-3 align-items-center" style="width: 100%;">
<strong for="content" class="p-3">Services Content</strong>
<br>    
        <textarea type="text" required name="textbox" class="fw-bold p-1 content"> Service content</textarea>
...
border-top-left-radius: 0;" id="pub">Publish</button>
...
setTimeout(function () {
// body...
$space_nav_loader('banner.php','sign','s-btn5');
