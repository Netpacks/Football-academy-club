...
$Sci_conl=$conn->prepare("SELECT * FROM blog WHERE id=? order by id DESC LIMIT 1");
$Sci_conl->bindParam(1, $get);
$Sci_conl->execute();
foreach ($Sci_conl as $Sci_colk) {

    $Sci_id = $Sci_colk['id'];
    $Sci_img1 = $Sci_colk['img1'];
    $Sci_topic = $Sci_colk['topic'];
    $Sci_content = $Sci_colk['textbox'];
    $Sci_date = $Sci_colk['date'];
...
<head>
 ...
 <meta name="twitter:image" content="./___p/uploads/<?php echo $weblogo; ?>">
 <meta property="og:image" content="./___p/uploads/<?php echo $weblogo; ?>">
...
<header class="header">
   ...
   <a href="./" class="logo"><img src="./___p//uploads/<?php echo $weblogo; ?>" alt="" style="height:50px;"></a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1"><?php echo $Sci_topic; ?></h1>
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2">Posted on <?php echo $Sci_date; ?> by Admin</div>
                            <!-- Post categories-->
                            <a class="badge bg-secondary text-decoration-none link-light" href="#!">gallerys</a>
                            <a class="badge bg-secondary text-decoration-none link-light" href="#!">blogs</a>
                        </header>
                        <!-- Preview image figure-->
                        <figure class="mb-4"><img class="img-fluid rounded" src="./___P/uploads/<?php echo $Sci_img1; ?>" alt="..." /></figure>
                        <!-- Post content-->
                        <section class="mb-5">
...
$Sci_con=$conn->prepare("SELECT * FROM blog order by id DESC LIMIT 15");
$Sci_con->execute();
...
?>
 ...
 <!-- Side widget--><a href="readmode.php?id=<?php echo $Sci_id; ?>"  style="text-decoration: none;" >
                    <div class="card mb-4">
                        <div class="card-header"><?php echo $Sci_topic; ?>...</div>
                        <div class="card-body"><?php echo $Sci_content; ?>...</div>
                    </div></a>
